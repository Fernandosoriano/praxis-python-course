class snake:
    ...
    def get_current_pos(self):
        return self.cells
# este método te dice si la viborita va a colisionar con otra viborita, o una manzana
...
# con esta aumentas el tamaño de la viborita
    def ate_apple(self):
        self.maxCells+=1
# lo siguiebtes controla el movimeitneo de la viborita
    ...
    def on_down_key(self):
        if(self.dy==0):
            self.dy= 1
            self.dx= 0
# esto es lo que mandas a cada una de los canvas
